...
public class SkeletonStateGrounded : SkeletonState
{
    ...
    public override void Update()
    {
        ...
        if (skeleton.PlayerDetectionRaycast() || Vector3.Distance(skeleton.transform.position, PlayerManager.instance.player.transform.position) < 2 && !PlayerManager.instance.player.IsDead())
        {
